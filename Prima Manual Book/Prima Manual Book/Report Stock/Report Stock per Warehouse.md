...
1. Buka menu **SIS Report Stock per Warehouse**
2. Input **tanggal pelaporan** dan **Locator**.

![Report](../par_stock_wh.png "Report Stock") {#Figure68}

3. Klik **Ok**
4. Sistem menampilkan Report Stock dalam format **Excel**.

![Report Excel](../report_stock_wh.png "Laporan Stock dalam Format Excel") {#Figure69}
