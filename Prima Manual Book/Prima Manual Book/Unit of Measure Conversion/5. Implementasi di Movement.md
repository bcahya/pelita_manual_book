...
![[Cuplikan layar 2026-05-21 085646.png]]

Field **Is Movement** menentukan bagaimana sistem mencatat quantity saat penerimaan barang:

- **Jika Is Movement dicentang (✓)** — Sistem mencatat quantity dalam satuan UoM Conversion (hasil konversi dari Base UoM).
- **Jika Is Movement tidak dicentang** — Sistem mencatat quantity langsung menggunakan satuan Base UoM.

## Implementasi UoM Conversion di Movement

![[Pasted image 20260521085925.png]]
...
![[Cuplikan layar 2026-05-21 090738.png]]

Di level Movement
![[Cuplikan layar 2026-05-21 090844.png]]

Karena field **Is Movement** tidak dicentang, sistem mencatat movement dalam satuan Base UoM.