...
![[Pasted image 20260519204042.png]]
...
```
[Samakan UoM Conversion yang digunakan untuk Requisition, Purchase Order, dan Movement untuk menjaga konsistensi data dan meminimalkan human error agar tidak terjadi kekeliruan] Rekomendasi Tim PSI
```
